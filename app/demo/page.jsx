  ...
  return (
    <>
      ...
      <header className=" container mx-auto max-w-screen-xl">
        ...
        <Anchor href="/">
          <AnchorLabel className="text-base font-sans hover:font-mono text-white border bg-blue-500 py-1 px-4 rounded-lg">
            main page
          </AnchorLabel>
        </Anchor>
        </div>
      ...
      <main className="container mx-auto max-w-screen-xl">
          ...
          <ul className="xl:grid lg:grid-cols-2 gap-4">
            ...
            <li className="sm:flex border border-gray-300 p-4 my-2 rounded-lg space-y-2">
              ...
              <ul className="px-10 list-disc">
                <li>Adds parts and quantity to the shopping cart.</li>
            ...
            <li className="sm:flex border border-gray-300 p-4 my-2 rounded-lg space-y-2">
              <button className="bg-transparent hover:bg-blue-500 text-blue-600 font-semibold hover:text-white
                                py-1 px-4 my-2 mx-4 border-2 border-blue-400 hover:border-transparent rounded h-12 shrink-0">
                Refresh
              </button>
              <ul className="px-10 list-disc">
            ...
            <li className="sm:flex border border-gray-300 p-4 my-2 rounded-lg space-y-2">
              ...
              <ul className="px-10 list-disc">
                <li>Check entered coupon validity: ensure it exists and checks if its within the date range.</li>
        ...
        <div className="border border-blue-400/50 p-4 rounded-lg shadow-md m-3">
          <h2 className="text-xl text-blue-600 tracking-wider font-semibold mb-2">Challenge</h2>
      ...
      <footer className="flex justify-end container mx-auto max-w-screen-xl m-10">
        <Anchor href="/">
          <AnchorLabel className="text-xl font-sans hover:font-mono text-white border bg-blue-500 py-2 px-5 rounded-lg">
            back to main page
          </AnchorLabel>
        </Anchor>
      </footer>
